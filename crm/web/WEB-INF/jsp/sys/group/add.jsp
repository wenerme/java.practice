                ...
                <div id="menu1">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="item.department" type="text" class="input" value="${item.department}"
                                       style="width: 90%">
                            </td>
                            ...
                            <td>
                                <input name="item.principal" type="text" class="input" value="${item.principal}"
                                       style="width: 90%">
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <textarea name="item.functional" rows="3" style="width: 96%">${item.functional}</textarea>
                            </td>
                        </tr>
                        <tr>
                            <td height="40" valign="top">
                            ...
                            <td colspan="3">
                                <textarea name="item.remark" rows="3" id="remark"
                                          style="width: 96%">${item.remark}</textarea>
                            </td>
                        </tr>
                    </table>
                </div>
